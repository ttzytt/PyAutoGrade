...
def make_move(player,move,board):
    ...
    if (move == '1A' or move == '1B' or move == '1C'
        or move == '2A' or move == '2B' or move == '2C'
        or move == '3A' or move == '3B' or move == '3C' or move == 'quit'):
...
def is_full(board,play_time):

    if play_time >= 9 and find_winner(board) == None:
