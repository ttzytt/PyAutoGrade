...
def make_move(board,ori,des):
    ...
    '''
    piece = board[int(ori[1])-1][ord(ori[0])-ord('A')]
    board[int(ori[1])-1][ord(ori[0])-ord('A')] = ' '
    board[int(des[1])-1][ord(des[0])-ord('A')] = piece
...
def undo_last_step(board,last_move):
    ...
    '''
    piece = board[int(des[1])-1][ord(des[0])-ord('A')]
    board[int(des[1])-1][ord(des[0])-ord('A')] = ' '
    board[int(ori[1])-1][ord(ori[0])-ord('A')] = piece
