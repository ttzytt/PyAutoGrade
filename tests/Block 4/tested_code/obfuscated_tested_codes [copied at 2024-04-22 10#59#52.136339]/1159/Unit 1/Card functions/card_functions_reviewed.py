...
def uno_who_played_what(card): 
    ...
    list = 0
    '''
    I think list and count should be two separate variables,
    because when there is a skip, I want to insert the next
    number as normal, but just skip the next player, thus the
    variable that controls the players and numbers should be
...
def uno_bonus_6(card,ini,num,start):
    ...
    '''
    Remember that the first player is 0
