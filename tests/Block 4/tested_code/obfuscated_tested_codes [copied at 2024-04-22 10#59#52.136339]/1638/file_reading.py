...
print('The file ' + file_name + " 's " + 'longest palindrome(s) is(are) ' + str(longest_palindrome))
print()


file_name = 'Text files/longest_word_test.txt'
with open(file_name, 'r') as my_file:
    vowels_counter = vowels_counter(my_file)

print('The file ' + file_name + ' contains ' + str(vowels_counter) + ' words that contain all five vowels')
print()


file_name = 'Text files/longest_word_test.txt'
with open(file_name, 'r') as my_file:
    count_long_lines = count_long_lines(my_file, 10)

print('The file ' + file_name + ' contains ' + str(count_long_lines) + ' lines longer than 10 ')
print()
...
print('The word is ' + str(random_word))
print()
