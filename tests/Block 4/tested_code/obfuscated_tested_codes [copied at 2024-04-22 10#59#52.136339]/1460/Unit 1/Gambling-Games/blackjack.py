...
print("""s
      ...
      Welcome to Baker's Blackjack!
      It's like normal Blackjack, just with a goal of 22!
...
print("""
      ...
      Here's how to play:
      The aim of this game is to draw cards summing up to as close as 22 as possible.
      However, if this sum goes over 22, you've busted.
...
print("""
      ...
      1) You will be dealt two cards.

      2) You are then able to either 'Hit' or 'Stand':
      To 'Hit' is to keep on drawing more cards until you stop.
      To 'Stand' is to stick with the two cards you were dealt.

      3) Once you're done, you'll compare your cards with Algorithm Andy:
      If both you and Andy busted, it's a draw (no money is gained or lost).
      If only one player busts, the other player automically wins what you've wagered.
      If no player busts, the player who wins is the one with the higher sum.
      In case of a tie in sums, noone wins or loses their bet.
...
print("""
      ...
      Cards:
      Baker's Blackjack uses the standard 52 card deck.
      However, all face cards (Jack, Queen, and King) are equal to 10.
      Additionally, Aces can be either 1 or 11.
