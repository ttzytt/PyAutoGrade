...
def determine_if_infected_TEST(total_trials):
    ...
    '''
    TESTS:
    (0.1, 2) - General Testing
    (0, 4) - No Probability with Neighbors
    (0.24, 4) - General Testing
    (0.9, 0) - No Neighbors
    (1,1) - 100% Probability w/ Neighbors
    (1,0) - 100% Probability with NO neighbors
    '''
...
def determine_if_still_infected_TEST(total_trials):
    ...
    0.1 - General
    0.9 - General
    0 - (should be™)No Healing Probability
    1 - (should be™)Guarenteed Healing Probability
    '''
