...
'''
False and '·' both refer to uninfected
True and 'x' both refer to infected
(Some tests use True/False where others use infected/uninfected
Infection probability is set to 0.2 default with 1 infected neighbor
Heal probability is set to 0.15 
