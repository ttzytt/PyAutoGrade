...
def has_full_house(suits):
    suits.sort()
    first_rank = suits[0]
    second_rank = suits[-1]
    
    return (suits == [first_rank, first_rank, first_rank, second_rank, second_rank]
        or suits == [first_rank, first_rank, second_rank,
