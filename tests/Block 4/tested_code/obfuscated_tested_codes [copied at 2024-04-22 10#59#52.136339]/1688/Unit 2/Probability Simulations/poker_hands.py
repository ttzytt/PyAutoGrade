...
def average_until_full_house(num_trials):
    
    total = 0

    for i in range(num_trials):
        total += simulate_full_house_odds()

    return total / num_trials


def simulate_odds(check_function):
...
trials = str(simulate_odds(input('What do you want to dealt?')))

print('The odds of being dealt a ___ is 1 in ' + trials + '.')
...
print(check_full_house(hand))
print(check_straight_flush(hand))
