...
'''
num_rounds = 0 # (keeps track of number of rounds)
while is_grid_mixed(grid) and num_rounds < 1000:
    simulate_round(grid, virus_infection_probability, heal_probability)
    num_rounds += 1
'''
