    ...
    for line in read_file:
        ...
        for word in words:
            if len(word) > len(longest_words[0]):
                ...
                longest_words = [word]
            elif len(word) == len(longest_words[0]) and word not in longest_words: 
...
def longest_palindrome(read_file):
    ...
    for line in read_file:
        ...
        for word in words:
            ...
            if len(word_lower) > len(longest_palindromes[0]) and word_lower == word_lower[::-1]:
                longest_palindromes = [word_lower] 
            elif len(word_lower) == len(longest_palindromes[0]) and word_lower == word_lower[::-1]:
