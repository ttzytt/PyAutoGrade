...
"""
Explanation of the Results of Flush Comparison

From several times of test, we may find that the odds for all five dice to have the same suit
is significently higher than the odds of  being dealt all kinds of flushes.

This is because when you randomly choose cards and try to form a flush, you can equate this process to pick one card randomly for 5 times.
However, there are only 13 cards in each suit, and therefore there are less 'target cards' in the total pool of cards each time,
after you pick out the first card. Thus, there are less and less chances to get the cards of the same suit.

On the other hand, in the process of rolling dice, the possibility to get the 'target suit' is constant,
which means the possibility doesn't decrease in each rolling process.

This causes the possibility of getting five dices of all the same suit to be higher.
""" 
