...
'''R
there are comments above each function, but no comments explaining how each part works. Not sure if those
are necessary.
I think you should put the printing average in a more amiable sentence.
'''
