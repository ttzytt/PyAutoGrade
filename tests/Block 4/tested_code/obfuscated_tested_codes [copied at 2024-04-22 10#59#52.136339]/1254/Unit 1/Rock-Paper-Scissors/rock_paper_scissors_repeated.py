...
'''
This program gives a twist on the original rock paper scissors program and plays multiple rounds.
Once the user doesn't want to play anymore they can type 'quit'.
'''
