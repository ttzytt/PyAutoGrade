...
def find_winner_TEST():
    ...
    board = [[ [' ', 'o', ' '],
            ...
            [ [' ', ' ', ' '],
              [' ', ' ', ' '],
              ['&', '&', '&']]]
    TEST('row win', '&', find_winner(board))
    ...
    board = [[ ['x', ' ', ' '],
            ...
            [ [' ', ' ', ' '],
              [' ', ' ', ' '],
              [' ', ' ', ' ']]]
    TEST('column win one layer', 'x', find_winner(board))
    ...
    board = [[ [' ', ' ', 'x'],
            ...
            [ [' ', ' ', '&'],
              [' ', ' ', ' '],
              [' ', ' ', ' ']]]
    TEST('column win one layer', 'o', find_winner(board))
    ...
    board = [[ ['o', ' ', ' '],
            ...
            [ [' ', ' ', '&'],
              [' ', ' ', '&'],
              [' ', ' ', '&']]]
    TEST('column win one layer', '&', find_winner(board))
    ...
    board = [[ ['x', ' ', ' '],
            ...
            [ ['x', ' ', ' '],
              [' ', ' ', ' '],
              [' ', ' ', ' ']]]
    TEST('column win three layer', 'x', find_winner(board))
    ...
    board = [[ [' ', 'o', ' '],
            ...
            [ [' ', 'o', ' '],
              [' ', ' ', ' '],
              [' ', ' ', ' ']]]
    TEST('column win three layer', 'o', find_winner(board))
    ...
    board = [[ ['o', ' ', ' '],
            ...
            [ [' ', ' ', ' '],
              [' ', ' ', ' '],
              [' ', '&', ' ']]]
    TEST('column win three layer', '&', find_winner(board))
    ...
    board = [[ ['x', ' ', ' '],
            ...
            [ [' ', ' ', ' '],
              [' ', ' ', ' '],
              [' ', ' ', ' ']]]
    TEST('diagonal win one layer', 'x', find_winner(board))
    ...
    board = [[ [' ', '&', '&'],
            ...
            [ [' ', ' ', ' '],
              [' ', ' ', ' '],
              [' ', ' ', ' ']]]
    TEST('diagonal win one layer', 'o', find_winner(board))
    ...
    board = [[ ['o', 'o', ' '],
            ...
            [ [' ', ' ', '&'],
              [' ', '&', ' '],
              ['&', ' ', ' ']]]
    TEST('diagonal win one layer', '&', find_winner(board))
...
def make_move_TEST():
    ...
    board = [[ ['&', ' ', '&'],
            ...
            [ [' ', ' ', ' '],
              [' ', ' ', ' '],
              [' ', ' ', ' ']]]
    TEST('accept legal move', True, make_move('o', '3G', board))
    expected_board = [[ ['&', ' ', '&'],
                      ['x', 'x', 'o'],
                      [' ', 'x', 'o'],],
                    [ [' ', ' ', ' '],
    ...
    TEST('dont change after rejected move', expected_board, board)
    TEST('reject move, space occupied', False, make_move('&', '2H', board))
    TEST('dont change after rejected move', expected_board, board)
    TEST('reject move, space occupied', False, make_move('x', '2E', board))
    TEST('dont change after rejected move', expected_board, board)
