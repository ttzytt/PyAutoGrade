...
'''
Finds the longest word or words in the file read_file.
    inputs:
        read_file    A file that is open for reading.
'''
...
'''
Finds the longest word in the file read_file that is a palindrome (the same forward and backward). 
    inputs:
        read_file    A file that is open for reading.
'''
...
'''
Returns the number of words in the file read_file that contain all five vowels A, E, I, O, and U,
...
'''
 Returns the number of lines in the file read_file that contain at least min_length characters.
 
    inputs:
        read_file    A file that is open for reading.
        min_length   The min length of lines.
'''
