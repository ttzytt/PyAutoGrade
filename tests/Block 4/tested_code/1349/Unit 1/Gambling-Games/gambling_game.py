...
print("Game rule: You have 100 dollars at the start of the game."
      ...
      "you win and get 10 dollars. Otherwize, you will lose 10 dollars. However,"
      "if the number you guess is the same with one of the numbers showed on the dices,"
      "you will lose 100 dollars at once.You will be out if you lose all your money."
...
while whether_continue == 'Yes': 
    ...
    if user_guess == 'quit':
        ...
        if user_guess < dice_1 and user_guess > dice_2:
            print('You win. You gain ten dollars!')
            money = money + 10
            ...
            print('You are so unluky! You lose 100 dollars!')
            money = money - 100
        
        else:
            print('You lose. You lose ten dollars!')
            money = money - 10
