...
def all_equal_TEST():
    ...
    TEST(all_equal([1,1,0,1,0]) == False)
...
def weird_double_TEST():
    ...
    TEST(weird_double([1,3,1,1,1,1,1,3,1]) == [2,3,1,1,1,2,2,3,1])
...
def merge_ordered_lists_TEST():
    ...
    TEST(merge_ordered_lists([1,3,4,7],[2,5,6]) == [1,2,3,4,5,6,7])
    TEST(merge_ordered_lists([-7,-4,-3,-1],[-6,-5,-2,1]) == [-7,-6,-5,-4,-3,-2,-1,1])
    
    TEST(merge_ordered_lists([0.1,0.2],[0.01,0.11,0.23]) == [0.01,0.1,0.11,0.2,0.23])
