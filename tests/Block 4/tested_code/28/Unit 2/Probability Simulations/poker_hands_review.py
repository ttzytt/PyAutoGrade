...
def average_until_full_house(num_trials, deck):
...
def average_until_straight_flush(num_trials, deck):
...
def average_until_flush(num_trials, deck):
...
def average_until_dice_flush(num_trials):
...
while get_simulation != 'q':
    print()
    if (get_simulation != 'fh' and get_simulation != 's'
        and get_simulation != 'fl' and get_simulation != 'd'): 
