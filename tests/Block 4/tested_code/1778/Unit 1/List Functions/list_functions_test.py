...
def all_equal_TEST():
    ...
    TEST(all_equal(['hello', 'dfsad', 'hello']) == False)
    TEST(all_equal(['hello', 'hello', 'hello']) == True)
    
    TEST(all_equal([1, 1, 1]) == True)
    TEST(all_equal([1, 2, 1]) == False)
...
def is_ordered_TEST():
    ...
    TEST(is_ordered([1, 3, 5, 2], True) == False)
    TEST(is_ordered([1, 2, 2, 4, 5, 6], True) == False)
    TEST(is_ordered([], True) == False)
...
def merge_ordered_lists_TEST():
    ...
    TEST(merge_ordered_lists([1, 5, 9], [2, 4, 8, 13]) == [1, 2, 4, 5, 8, 9, 13])
    
    TEST(merge_ordered_lists([], []) == [])
    TEST(merge_ordered_lists([], [1, 3]) == [1, 3])
    TEST(merge_ordered_lists([1, 3], []) == [1, 3])
    print('End merge_ordered__lists_TEST')
    print()
