...
'''
This is a 4-people-uno game. [red,5] is represented as 5R,
[blue,8] is represented as 8B, [yellow,skip] is represented
as SY, [green,reverse] is represented as RG. You should be
able to know the corresponding code for each card, enjoy
your game!
'''
