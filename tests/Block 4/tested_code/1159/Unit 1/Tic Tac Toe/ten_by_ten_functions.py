...
def find_winner(board):
    ...
    for dia_1 in range(6):

        if board[dia_1][dia_1] == board[dia_1+1][dia_1+1] == board[dia_1+2][dia_1+2] == board[dia_1+3][dia_1+3] == board[dia_1+4][dia_1+4]:

            if board[dia_1][dia_1] == 'x':
                return 'x'
            elif board[dia_1][dia_1] == 'O':
                return 'o'

    for dia_2 in range(6):

        if board[dia_2][9-dia_2] == board[dia_2+1][9-dia_2-1] == board[dia_2+2][9-dia_2-2] == board[dia_2+3][9-dia_2-3] == board[dia_2+4][9-dia_2-4]:

            if board[dia_2][9-dia_2] == 'x':
                return 'x'
            elif board[dia_2][9-dia_2] == 'o':
                return 'o'
