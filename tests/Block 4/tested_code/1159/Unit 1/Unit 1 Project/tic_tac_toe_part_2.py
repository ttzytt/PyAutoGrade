...
'''
Your program is generally great. However, the program doesn't block the occasion that
the player enters things like '1AW' in wrong places. You may need to improve the
code in these area. Also notice that 'NNN' will be accepted
'''
