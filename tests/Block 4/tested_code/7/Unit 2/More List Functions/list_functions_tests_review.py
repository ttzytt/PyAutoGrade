...
def item_moved_to_end_TEST():
    ...
    expected_list = [1, 3, 4, 2, 15, 2, 16]
    TEST('Middle Element Succeed', expected_list, my_list)
    ...
    my_list = []
    TEST('All Same', [], item_moved_to_end(my_list, 2))
    expected_list = []
...
def move_item_to_end_TEST():
    ...
    TEST('None', None, move_item_to_end(my_list, 2))
    expected_list = []
    TEST('None Succeed', expected_list, my_list)
