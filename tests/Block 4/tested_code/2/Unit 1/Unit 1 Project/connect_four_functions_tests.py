...
def make_move_TEST():
    ...
    board = [ [' ', ' ', ' ', ' '],
              ...
              ['o', ' ', 'o', ' '],
              ['x', 'o', 'x', 'x'] ]
    TEST('accept legal move', True, make_move('x', 'A', board))
    expected_board = [ [' ', ' ', ' ', ' '],
                       ['x', ' ', ' ', ' '],
                       ['o', ' ', 'o', ' '],
                       ['x', 'o', 'x', 'x'] ]
    ...
    board = [ [' ', ' ', ' ', ' '],
              ...
              ['o', ' ', 'o', ' '],
              ['x', 'o', 'x', 'x'] ]
    TEST('accept legal move', True, make_move('o', 'B', board))
    expected_board = [ [' ', ' ', ' ', ' '],
                       ['x', ' ', ' ', ' '],
                       ['o', 'o', 'o', ' '],
                       ['x', 'o', 'x', 'x'] ]
    ...
    board = [ ['o', 'x', ' ', ' '],
              ...
              ['x', 'o', ' ', ' '] ]
    expected_board = board
    TEST('reject move, space occupied', False, make_move('x', 'A', board))
    TEST('dont change after rejected move', expected_board, board)
    TEST('reject move, space occupied', False, make_move('o', 'A', board))
    TEST('dont change after rejected move', expected_board, board)
