...
''')
    ...
    if (userChoice == 'rock' or userChoice == 'paper' or userChoice == 'scissors'):
        ...
        elif ((computer_rps_choice =='rock' and userChoice == 'scissors')
              or (computer_rps_choice =='scissors' and userChoice == 'paper')
              or (computer_rps_choice =='paper' and userChoice == 'rock')):
        ...
        print('''You have angered the supreme all-mighty being of doom.
Prepare to face the vengence of the mighty Meowthra!!
⠀⡤⠤⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⠠⢤⠀
⠀⠈⢧⡀⠉⠒⠤⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⠤⠒⠉⢀⣴⠃⠀
⠀⠀⠈⠻⡢⡀⠀⠀⡁⠢⠐⠒⠀⠉⠉⠉⠉⠁⠒⠒⠔⠊⠀⠀⢀⠔⠕⠁⠀⠀
⠀⠀⠀⠀⠈⢺⢆⢰⡟⠁⠀⠀⠀⣴⡴⢢⣦⠀⠀⠀⠀⠀⠀⠰⡧⠃⠀⠀⠀⠀
