...
def main():
    with open('Text files/greeneggs.txt', 'r') as read_file:
        word_dictionary = prefix_counts(read_file)
        ...
        for key in word_dictionary.keys():
            ...
            if (word_dictionary[key] > second_common_prefix_int
                        and key != most_common_prefix_string):
        ...
        print("The most common prefix is",most_common_prefix_string,
              "occurring",most_common_prefix_int, "times") 
        print("The next most common prefix is",second_most_common_prefix_string,
              "occurring",second_common_prefix_int, "times")
