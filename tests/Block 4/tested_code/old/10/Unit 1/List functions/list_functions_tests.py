...
def all_equal_TEST():
    ...
    TEST(all_equal(['hello', 'hello', 'hello']) == True)
    TEST(all_equal([2, 2, 2, 2, 2, 4]) == False)
    TEST(all_equal([3, 2, 2, 2, 2, 2,]) == False)
...
def alternate_sum_TEST():
    ...
    TEST(alternate_sum([-1,-100,20,5]) == 114)
...
def rotate_right_TEST():
    ...
    TEST(rotate_right([-6,2,5,9,8]) == [8,-6,2,5,9])
    TEST(rotate_right([1,3,3,7]) == [7,1,3,3])
    TEST(rotate_right([]) == 0)
...
def merge_ordered_lists_TEST():
    ...
    TEST(merge_ordered_lists([2, 2, 8], [1, 3]) == [1, 2, 2, 3, 8])
    TEST(merge_ordered_lists([-5,2,], [5, 6]) == [-5, 2, 5, 6])
    TEST(merge_ordered_lists([], []) == 0)   
