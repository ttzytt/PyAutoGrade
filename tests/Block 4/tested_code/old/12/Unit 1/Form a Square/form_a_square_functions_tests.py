...
def find_winner_TEST():
    ...
    board = [ [' ', 'x', ' ', 'x'],
              ...
              [' ', 'x', ' ', 'x'],
              [' ', 'o', ' ', ' '] ]
    TEST('square win', 'x', find_winner(board))
    
    board = [ [' ', 'x', ' ', ' '],
              ['x', 'o', ' ', 'o'],
              [' ', 'x', ' ', ' '],
              [' ', 'o', ' ', 'o'] ]
    TEST('square win', 'o', find_winner(board))
    ...
    board = [ [' ', 'x', ' ', ' '],
              ...
              [' ', 'x', ' ', ' '],
              [' ', 'o', ' ', ' '] ]
    TEST('Diamond win', 'x', find_winner(board))
    
    board = [ [' ', 'x', 'o', ' '],
              ['x', 'o', 'x', 'o'],
              ['x', ' ', 'o', ' '],
              [' ', ' ', ' ', ' '] ]
    TEST('Diamond win', 'o', find_winner(board))
    ...
    board = [ [' ', 'x', ' ', ' '],
              ...
              [' ', 'x', 'o', ' '],
              [' ', 'o', ' ', 'o'] ]
    TEST('Center move opponent win', 'o', find_winner(board))
    
    board = [ [' ', 'x', 'x', ' '],
              ['x', 'o', ' ', 'o'],
              [' ', 'x', 'o', ' '],
              [' ', 'o', ' ', 'o'] ]
    TEST('Center move opponent win', 'x', find_winner(board))
...
def make_move_TEST():
    ...
    board = [ [' ', 'x', ' ', ' '],
              ...
              [' ', 'x', ' ', ' '],
              [' ', 'o', ' ', ' '] ]
    TEST('accept legal move', True, make_move('x', '2C', board))
    expected_board = [ [' ', 'x', ' ', ' '],
                       ['x', 'o', 'x', 'o'],
                       [' ', 'x', ' ', ' '],
                       [' ', 'o', ' ', ' '] ]
    ...
    board = [ [' ', 'x', ' ', ' '],
              ...
              [' ', 'x', 'x', ' '],
              [' ', 'o', ' ', ' '] ]
    TEST('accept legal move', True, make_move('o', '4D', board))
    expected_board = [ [' ', 'x', ' ', ' '],
                       ['x', 'o', ' ', 'o'],
                       [' ', 'x', 'x', ' '],
                       [' ', 'o', ' ', 'o'] ]
    ...
    TEST('dont change after rejected move', expected_board, board)
    TEST('reject move, off board', False, make_move('o', '1E', board))
    TEST('dont change after rejected move', expected_board, board)
    ...
    board = [ [' ', 'x', ' ', ' '],
              ...
              [' ', 'o', ' ', ' '] ]
    expected_board = board
    TEST('reject move, space occupied', False, make_move('x', '2B', board))
    TEST('dont change after rejected move', expected_board, board)
