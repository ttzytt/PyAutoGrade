...
def unreadable_detective(cards_played, num_players, starting_player):
    is_reversed = False
    returning_table = [[] for x in range(num_players)]
    hand = starting_player
    for card in cards_played:
        returning_table[hand%num_players].append(card)
        if card == 'reverse':
...
print(unreadable_detective(['1', '2', 'reverse', 'reverse', '5', 'skip', '7'],4,0))
