...
average_until_duplicate = average_rolls_until_all_values(num_trials) 
print('The average amount of rolls until all dice values are achieved is ' + str(average_until_duplicate))
