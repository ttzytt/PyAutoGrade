...
def deal_3_hands_TEST():
    print('deal_3_hands_TEST')
    TEST(deal_3_hands([1,2,3,4,5]) == [[1,4],[2,5],[3]])
    TEST(deal_3_hands([1,2]) == [[1],[2],[]])
    TEST(deal_3_hands([1,2,4,6,7,8]) == [[1,6],[2,7],[4,8]])
    TEST(deal_3_hands([]) == [[],[],[]])
...
def catch_cheater_TEST():
    print('catch_cheater_TEST')
    TEST(catch_cheater([['2','yellow'],['reverse','yellow'],['skip','yellow'],['draw 2','red']],['3','yellow'])==3)
    TEST(catch_cheater([['2','yellow'],['reverse','yellow'],['skip','blue'],['draw 2','red']],['3','yellow'])==1)
    TEST(catch_cheater([['2','yellow'],['reverse','yellow'],['skip','yellow'],['draw 2','red']],['3','yellow'],5,3)==1)
    TEST(catch_cheater([['2','yellow'],['reverse','yellow'],['skip','yellow'],['draw 2','red']],['3','yellow'],3,1)==2)
