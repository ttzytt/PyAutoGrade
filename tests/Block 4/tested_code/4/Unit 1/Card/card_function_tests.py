...
def deal_3_hands_TEST():
    ...
    TEST(deal_3_hands([-7, -6, -5, -4, -3, -2, -1]) == [[-7, -4, -1], [-6, -3], [-5, -2]])
    TEST(deal_3_hands([1, 3, 5, 7, 9, 10, 11]) == [[1, 7, 11], [3, 9], [5, 10]])
    TEST(deal_3_hands([-2, 2, 4, 5, 6, 7, 10]) == [[-2, 5, 10], [2, 6], [4, 7]])
    print('End Start deal_3_hands_TEST')
    print()
